...
# class FollowNewUserView(generics.CreateAPIView):
    ...
    def post(self, request, pk):
        ...
        try:
            ...
            if 'unique constraint' in str(e).lower():
                ...
                return Response({'error': 'An IntegrityError occurred. Please check your request.'}, status=status.HTTP_409_CONFLICT)
